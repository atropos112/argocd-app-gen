...
class AtroApp(App):
    ...
    def setup_manifest(self) -> None:
        self.manifest["spec"]["source"]["plugin"] = {}
        self.manifest["spec"]["source"]["plugin"]["parameters"] = []
        self.manifest["spec"]["source"]["plugin"]["parameters"].append({"name": "values-file", "string": self.value_file_path.name})
